...
export async function POST(req: Request) {
  console.log('Webhook de IziPay recibido! [MODO DEBUG]');
  ...
  formData.forEach((value, key) => {
    if (key === 'kr-answer') {
      try {
        ...
        console.error("Error al parsear kr-answer:", e);
        params[key] = value;
      }
    } else {
        params[key] = value;
  ...
  // ===============================================================================================
  // MODO DEBUG: Imprimir todos los parámetros recibidos para análisis
  // ===============================================================================================
  console.log("IZIPAY WEBHOOK BODY RECIBIDO:", JSON.stringify(params, null, 2));
  // ===============================================================================================


  /*
  // ===============================================================================================
  // LÓGICA DE VERIFICACIÓN DE FIRMA (Temporalmente desactivada para depuración)
  // ===============================================================================================
  ...
  if (receivedSignature !== local_signature) {
    ...
    // Para depuración, mostramos ambas firmas
    console.log("Firma Recibida:", receivedSignature);
    console.log("Firma Calculada:", local_signature);
    console.log("Cadena usada para calcular:", string_to_sign);
  ...
  */
  ...
  /*
  // ===============================================================================================
  // LÓGICA DE CREACIÓN DE ORDEN (Temporalmente desactivada para depuración)
  // ===============================================================================================
  try {
  ...
  */
  ...
  // Devolvemos una respuesta exitosa para que Izipay no siga reintentando el webhook.
  return NextResponse.json({ status: 'ok', message: 'Webhook recibido en modo debug. Ver logs del servidor.' });
}